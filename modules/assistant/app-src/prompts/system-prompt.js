...
const TOOL_GUIDELINES = [
    ...
    ' - Inspect first with LS/Glob/Grep/Read, then modify with Write/apply_patch/Move/Delete as needed.',
    ' - Prefer `apply_patch` for targeted edits and multi-file changes; use Write for new files or full-file rewrites.',
    '',
    '## Using Skills',
